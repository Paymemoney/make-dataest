...
def build_from_path(in_dir, out_dir, num_workers=1, tqdm=lambda x: x):
  ...
  trn_files = []
  trn_files += glob.glob(os.path.join(in_dir, 'data_30.61', '*.trn'))
  trn_files += glob.glob(os.path.join(in_dir, 'data_30.61_augmentation', '*.trn'))
  #trn_files += glob.glob(os.path.join(in_dir, 'data_6', 'group1', '*.trn'))
  #trn_files += glob.glob(os.path.join(in_dir, 'data_6', 'group2', '*.trn'))
  #trn_files += glob.glob(os.path.join(in_dir, 'data_6', 'group3', '*.trn'))
