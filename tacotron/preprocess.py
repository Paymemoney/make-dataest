...
from datasets import blizzard, ljspeech, thchs30, femalemandarin,biaobei
...
def preprocess_biaobei(args):
  in_dir = os.path.join(args.base_dir, 'biaobei-1.0')
  out_dir = os.path.join(args.base_dir, args.output)
  os.makedirs(out_dir, exist_ok=True)
...
def main():
  ...
  parser.add_argument('--dataset', required=True, choices=['blizzard', 'ljspeech', 'thchs30', 'femalemandarin', 'biaobei'])
